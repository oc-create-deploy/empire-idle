...
public static class BuildScript
{
    public static void BuildIos()
    {
        ...
        const string appIconPath = "Assets/Brand/EmpireIdle-AppIcon.png";
        Directory.CreateDirectory(outputPath);
        EnsureScene();

        PlayerSettings.companyName = "Playable Games";
        PlayerSettings.productName = "Empire Idle";
        PlayerSettings.SetApplicationIdentifier(BuildTargetGroup.iOS, "Com.play.idletycoon");
    ...
    private static void EnsureScene()
    {
        ...
        var root = new GameObject("Empire Idle");
        root.AddComponent<EmpireIdleGame>();
